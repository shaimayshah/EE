...
\caption{Completed passes between starters, Barça 2011 (Opta). Row = passer, column = receiver.}
\label{tab:matrix-0}
...
\begin{table}[p]
\centering\small\setlength{\tabcolsep}{3.5pt}
\caption{Completed passes between starters, Man Utd 2011 (Opta). Row = passer, column = receiver.}
\label{tab:matrix-1}
\begin{tabular}{l*{11}{r}}
\toprule
...
\begin{table}[p]
\centering\small\setlength{\tabcolsep}{3.5pt}
\caption{Completed passes between starters, Barça 2015 (Opta). Row = passer, column = receiver.}
\label{tab:matrix-2}
\begin{tabular}{l*{11}{r}}
\toprule
...
\begin{table}[p]
\centering\small\setlength{\tabcolsep}{3.5pt}
\caption{Completed passes between starters, Juventus 2015 (Opta). Row = passer, column = receiver.}
\label{tab:matrix-3}
\begin{tabular}{l*{11}{r}}
\toprule
