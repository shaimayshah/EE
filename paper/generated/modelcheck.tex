...
Basic Poisson model & 0.2467 & 1.106 & 0.659 & 46.6\% \\
Basic Poisson + home advantage & 0.2350 & 1.071 & 0.634 & 48.8\% \\
...
\midrule
Basic Poisson $-$ base rates & $+0.0138$ & $[-0.0062,\ +0.0350]$ \\
Basic Poisson + home $-$ base rates & $+0.0022$ & $[-0.0158,\ +0.0213]$ \\
Dixon--Coles $-$ base rates & $-0.0118$ & $[-0.0208,\ -0.0017]$ \\
Adding home advantage & $-0.0116$ & $[-0.0180,\ -0.0053]$ \\
Dixon--Coles $-$ basic Poisson + home & $-0.0139$ & $[-0.0243,\ -0.0038]$ \\
\bottomrule
\end{tabular}
\end{table}
